...
$("#mobile_quote_btn_link").on("click", function (a) {
	...
	$("select").on("change", function () {
		"0" != this.value && ($("#progress8").removeAttr("hidden"), $("#progress4").hide(), $("#progressBar8").animate({
			width: "100%"
		}, 300))
	});
	var a = $(".sightbox__slideshow");
	$("#sightbox__slide--2").show(), a.slick({
		arrows: !1,
		autoplay: !0,
		infinite: !1,
		dots: !0
	});
	var b = document.querySelectorAll(".slick-dots button");
	b.forEach(c), a.on("afterChange", function (b, c, d) {
	...
	var b = document.querySelectorAll(".slick-dots button");
	b.forEach(c), d.on("afterChange", function (a, b, c) {
...
// 	errorMsg = document.querySelector("#phoneError"),
// 	input = document.querySelector("#phone"),
// 	iti = window.intlTelInput(input, {
// 		initialCountry: "auto",
// 		geoIpLookup: function (a) {
// 			$.get("https://ipinfo.io?token=0456b309bc7337", function () {}, "jsonp").always(function (b) {
// 				var c = b && b.country ? b.country : "";
// 				a(c)
// 			})
// 		}
// 	});
$("#phone").on("input", function () {
    ...
    if (10 == input.value.trim().length) {
        var b = "+" + iti.getSelectedCountryData().dialCode;
			console.log(b), $("#phoneCode").text(b), phoneCheck()
		} else  {
		input.classList.add("error");
		errorMsg.innerHTML = "Error. Enter valid number.", errorMsg.classList.remove("hide"), PhoneNext.classList.remove("show"), phoneError.innerHTML = "Error. Enter valid number.", PhoneNext.classList.add("dissable")
	}
});
